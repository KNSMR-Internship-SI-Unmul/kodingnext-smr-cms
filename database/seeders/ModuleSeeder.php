...
class ModuleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $modules = [
            ...
            [
                'name' => 'Minecraft: Coding, AI & Cyber Adventures',
                'description' => 'Siswa akan mempelajari pemrograman Python, konsep AI tingkat lanjut, serta dasar-dasar keamanan siber. Mereka akan membuat proyek interaktif di Minecraft untuk menyelesaikan permasalahan dunia nyata dan meningkatkan kemampuan problem solving.',
                'age_range' => '8-12',
                'duration_per_session' => 90,
                'category' => 'Game Development',
                'course_type_id' => 2,
            ...
            [
                ...
                'description' => 'Siswa akan mempelajari dasar-dasar pemrograman website menggunakan HTML & CSS untuk membuat website statis sederhana, serta memahami struktur website dan cara kerja internet.',
                'age_range' => '8-12',
                'duration_per_session' => 90,
                'category' => 'App Development',
                'course_type_id' => 2,
            ...
            [
                'name' => 'Robotics',
                'description' => 'Siswa akan mempelajari dasar Arduino, mengontrol robot dengan sensor dan modul, serta membuat proyek seperti line-following, obstacle avoidance, dan kontrol Bluetooth. Mereka juga akan mengembangkan keterampilan coding, perakitan, dan kalibrasi sensor hingga menghasilkan proyek akhir.',
                'age_range' => '12-16',
                'duration_per_session' => 90,
                'course_type_id' => 2,
            ],
