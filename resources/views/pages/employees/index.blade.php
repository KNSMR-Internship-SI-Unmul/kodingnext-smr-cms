...
@section('content')
<div x-data="{ showEmployeeModal: {{ $errors->any() ? 'true' : 'false' }}, showDeleteModal: false }">
        ...
        <div class="bg-white rounded-lg shadow-sm hover:shadow-md overflow-hidden flex flex-col h-full group relative transition-all duration-300 hover:-translate-y-1 border border-gray-100">
            <div class="relative h-56 w-full bg-gray-100">
                <div class="absolute top-4 right-4 z-20" x-data="{ openDropdown: false }">
                    ...
                    >
                        <button @click="openDropdown = false; showEmployeeModal = true" class="w-full text-left px-4 py-2.5 text-sm font-semibold text-gray-700 hover:bg-gray-50 hover:text-brand-pink flex items-center gap-2 transition-colors">
                ...
                <img src="https://i.pravatar.cc/300?img=5" alt="Profile" class="w-full h-full object-cover">
                
                <div class="absolute bottom-0 left-0 right-0 p-5 bg-gradient-to-t from-brand-pink/90 via-brand-pink/40 to-transparent pt-12">
                    <h3 class="font-bold text-white text-sm leading-tight mb-0.5">Rinda Lailatul Arofah, S. Kom.</h3>
                    <p class="text-xs text-white/90 font-medium">Student Advisor</p>
                </div>
            </div>
            ...
            <div class="p-5 flex-1 flex flex-col">
                <div class="flex justify-between items-center mb-3">
                    <div>
                        <p class="text-xs text-gray-400 font-medium mb-1">Program</p>
                        <p class="text-sm font-bold text-brand-pink">Little Koders</p>
                    </div>
                    <div class="text-right">
                        <p class="text-xs text-gray-400 font-medium mb-1">Hired Date</p>
                        <p class="text-sm font-bold text-gray-900">10/10/2026</p>
                    </div>
                </div>

                <div class="mt-auto text-center">
                    <button class="text-sm font-medium h-full w-full text-gray-700 hover:text-brand-pink hover:bg-gray-50 rounded-lg py-2 transition-colors">
                        View Details
                    </button>
                </div>
            </div>
            ...
            <div class="relative h-56 w-full bg-gray-100">
                <div class="absolute top-4 right-4 z-20" x-data="{ openDropdown: false }">
                    ...
                    <div 
                        ...
                        x-transition:enter-end="transform opacity-100 scale-100"
                    >
                        <button @click="openDropdown = false; showEmployeeModal = true" class="w-full text-left px-4 py-2.5 text-sm font-semibold text-gray-700 hover:bg-gray-50 hover:text-brand-blue flex items-center gap-2 transition-colors">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                            Edit
                        </button>
                        <button @click="openDropdown = false; showDeleteModal = true" class="w-full text-left px-4 py-2.5 text-sm font-semibold text-red-600 hover:bg-red-50 flex items-center gap-2 transition-colors border-t border-gray-100">
                ...
                <img src="https://i.pravatar.cc/300?img=11" alt="Profile" class="w-full h-full object-cover">
                ...
                <div class="absolute bottom-0 left-0 right-0 p-5 bg-gradient-to-t from-brand-blue/90 via-brand-blue/40 to-transparent pt-12">
                    <h3 class="font-bold text-white text-sm leading-tight mb-0.5">Muhammad Kurnia Dewanto Ramadhansyah, S. Kom.</h3>
                    <p class="text-xs text-white/90 font-medium">Advanced Teacher</p>
                </div>
            </div>

            {{-- Bagian Bawah: Info & Tombol Detail --}}
            <div class="p-5 flex-1 flex flex-col">
                <div class="flex justify-between items-center mb-3">
                    <div>
                        <p class="text-xs text-gray-400 font-medium mb-1">Program</p>
                        <p class="text-sm font-bold text-brand-blue">Junior Koders</p>
                    </div>
                    <div class="text-right">
                        <p class="text-xs text-gray-400 font-medium mb-1">Hired Date</p>
                        <p class="text-sm font-bold text-gray-900">10/10/2023</p>
                    </div>
                </div>

                <div class="mt-auto text-center">
                    <a href="/employees/{id}" class="block text-sm font-medium h-full w-full text-gray-700 hover:text-brand-blue hover:bg-gray-50 rounded-lg py-2 transition-colors">
                        View Details
                    </a>
                </div>
            </div>
