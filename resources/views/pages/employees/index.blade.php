        ...
        <div class="flex flex-col sm:flex-row items-center justify-between text-sm text-gray-500 px-2 mt-5">
            ...
            <div class="flex items-center gap-6 mt-4 sm:mt-0">
                ...
                <div class="flex items-center gap-4">
                    ...
                    @else
                        <a href="{{ $employees->previousPageUrl() }}&search={{ request('search') }}&per_page={{ request('per_page', 12) }}" class="text-brand-blue hover:text-brand-blue-hover transition-colors flex items-center gap-1 font-medium">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path></svg>
                            Prev
                        </a>
                    @endif
                    ...
                    @if ($employees->hasMorePages())
                        <a href="{{ $employees->nextPageUrl() }}&search={{ request('search') }}&per_page={{ request('per_page', 12) }}" class="text-brand-blue hover:text-brand-blue-hover transition-colors flex items-center gap-1 font-medium">
                            Next
